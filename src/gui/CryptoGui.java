 ...
 * @author Dell
 */
import encryptiondecryption.EncryptionDecryption;
...
import encryptiondecryption.Print;
import javax.swing.UIManager;
import javax.swing.SwingUtilities;
public class CryptoGui extends javax.swing.JFrame {
    ...
    public void process(){
       ...
       int loop;
        ...
        try {
            ...
            EncryptionDecryption crypto = new EncryptionDecryption(txt_inputE.getText(), String.valueOf(cmb_alg.getSelectedItem()));
    ...
    private void txt_inputEActionPerformed(java.awt.event.ActionEvent evt) {                                           
    }                                          
    ...
    private void txt_lenActionPerformed(java.awt.event.ActionEvent evt) {                                        

    }                                       

    private void txt_outputEActionPerformed(java.awt.event.ActionEvent evt) {                                            

    }                                           

    private void btn_processKeyPressed(java.awt.event.KeyEvent evt) {                                       
